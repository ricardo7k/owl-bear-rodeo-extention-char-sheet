...
document.getElementsByClassName("icon-dice-solo")[0].addEventListener('click', rollAttrSolo);

geid("box_results").addEventListener("click", clearTable)
